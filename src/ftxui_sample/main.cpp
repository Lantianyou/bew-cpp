...
// configuration step. It creates a namespace called `bew_cpp`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", bew_cpp::cmake::project_name, bew_cpp::cmake::project_version) };
